...
- (TLAlertView *)initWithTitle:(NSString *)title message:(NSString *)message inView:(UIView *)view cancelButtonTitle:(NSString *)cancelButton confirmButton:(NSString *)confirmButton {
    ...
    else if ([myString isEqual:@"parent"])
    {
        _titleColor = [UIColor blackColor];
        _messageColor = [UIColor blackColor];
        _confirmTextColor = [UIColor whiteColor];
        _cancelTextColor = [UIColor whiteColor];
        _buttonColor = [UIColor purpleColor];
        //    _buttonColor = [UIColor colorWithRed:0.000 green:0.502 blue:1.000 alpha:1.000];
        _viewColor = [UIColor whiteColor];
        // _viewColor = [UIColor colorWithRed:0.174 green:0.182 blue:0.173 alpha:1.000];
    ...
    _titleColor = [UIColor colorWithRed:12.0/255.0 green:158.0/255.0 blue:239.0/255.0 alpha:1];
    _messageColor = [UIColor colorWithRed:12.0/255.0 green:158.0/255.0 blue:239.0/255.0 alpha:1];
    _confirmTextColor = [UIColor whiteColor];
    _cancelTextColor = [UIColor whiteColor];
    _buttonColor = [UIColor colorWithRed:35.0/255.0 green:57.0/255.0 blue:86.0/255.0 alpha:1];
    //    _buttonColor = [UIColor colorWithRed:0.000 green:0.502 blue:1.000 alpha:1.000];
    _viewColor = [UIColor whiteColor];
    // _viewColor = [UIColor colorWithRed:0.174 green:0.182 blue:0.173 alpha:1.000];
    _borderColor = [UIColor colorWithRed:12.0/255.0 green:158.0/255.0 blue:239.0/255.0 alpha:1];
    // _borderColor = [UIColor whiteColor];
    ...
    if(cancelButton && confirmButton) {
        _cancelButton = ({
            ...
            button.titleLabel.font = [UIFont fontWithName:@"System" size:20];
