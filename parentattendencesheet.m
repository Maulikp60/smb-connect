...
@interface parentattendencesheet ()<CDRTranslucentSideBarDelegate>
{
    NSMutableArray *arrStudent,*arrStuid,*arrrootid;
    NSString *Profile;
...
@implementation parentattendencesheet
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [self countingdata];
 /*   _slices = [[NSMutableArray alloc]initWithObjects:@"1",@"2",@"3",nil];
    ...
    self.sliceColors =[NSArray arrayWithObjects:
                       ...
                       [UIColor colorWithRed:0/255.0 green:255.0/255.0 blue:0/255.0 alpha:1],
                       [UIColor colorWithRed:0/255.0 green:0/255.0 blue:255.0/255.0 alpha:1],nil];*/
...
-(void)countingdata
{
    ...
    NSString *myRequestString1 = [NSString stringWithFormat:@"%@attendence_sheet.php?stud_id=%@",[[Singleton sharedSingleton] getBaseURL],stdid];
    ...
    [operation1 setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[dictionary2 valueForKey:@"status"] isEqualToString:@"YES"] )
        {
            ...
            [_slices addObject:[[arr objectAtIndex:0]objectForKey:@"absent"]];
            [_slices addObject:[[arr objectAtIndex:0]objectForKey:@"leave"]];
            [_slices addObject:[[arr objectAtIndex:0]objectForKey:@"present"]];
            ...
            self.sliceColors =[NSArray arrayWithObjects:
                               [UIColor colorWithRed:17.0/255.0 green:195.0/255.0 blue:215.0/255.0 alpha:1],
                               [UIColor colorWithRed:120.0/255.0 green:254.0/255.0 blue:254.0/255.0 alpha:1],
                               [UIColor colorWithRed:154.0/255.0 green:188.0/255.0 blue:83.0/255.0 alpha:1],nil];
        ...
        else
        {
            ...
            TLAlertView *alertView = [TLAlertView showInView:self.view withTitle:@"SMBConnect" message:[dictionary2 objectForKey:@"message"] confirmButtonTitle:NULL 	cancelButtonTitle:@"OK"];
...
- (NSString *)pieChart:(XYPieChart *)pieChart textForSliceAtIndex:(NSUInteger)index
{
    if (index==0)
    {
        return [NSString stringWithFormat:@"%@",[_slices objectAtIndex:index]];
    }
    else if (index==1)
    {
        return [NSString stringWithFormat:@"%@",[_slices objectAtIndex:index]];
    ...
    {
        return [NSString stringWithFormat:@"%@ Leave",[_slices objectAtIndex:index]];
    }
}
...
- (IBAction)btnleve:(id)sender {
    LeaveApplicationScreen *LeaveApplicationScreen=[self.storyboard instantiateViewControllerWithIdentifier:@"LeaveApplicationScreen"];
    [self presentViewController:LeaveApplicationScreen animated:YES completion:nil];
